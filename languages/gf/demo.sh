...
autumn='Row 4 (Many (BaseFCell (TimeSeason (ncn season_2_N) (FNullary (VS "Autumn"))) (AmountCount (ncn guest_1_N) (ncn count_1_N)  (FInRangeInt 5 8)))) (Single (Attribute (ncn dish_2_N) (FNullary (VS "Instant noodles")))) NoComment'
other='Row 5 (Many (BaseFCell (TimeSeason (ncn season_2_N) FAnything) (AmountCount (ncn guest_1_N) (ncn count_1_N)  FAnything))) (Single (Attribute (ncn dish_2_N) (FNullary (VS "Pea soup")))) (CommentString "I give up")'
